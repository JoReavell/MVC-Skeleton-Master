        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <article class="post">
                    <header>
                        <div class="title">
                            <h2><a href="#">Sky Academy</a></h2>
                            <p>Lorem ipsum dolor amet nullam consequat etiam feugiat</p>
                        </div>
                        <div class="meta">
                            <time class="published" datetime="2018-04-14">April 14, 2018</time>
                            <a href="#" class="author"><span class="name">Jen Patchet</span><img src="images/JenPat.png" alt="" /></a>
                        </div>
                    </header>
                    <div class="format-video">
                        <iframe  src="https://www.youtube.com/embed/_WYlhzLYTDY" frameborder="0" allowfullscreen></iframe>
                    </div>
